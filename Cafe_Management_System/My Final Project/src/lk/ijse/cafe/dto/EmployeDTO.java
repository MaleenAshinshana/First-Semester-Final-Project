...
public class EmployeDTO {
    ...
    public EmployeDTO(String employe_id) {
        this.employe_id = employe_id;
    }

    public EmployeDTO(String employe_id, String name, String address, String email, int contact_num, String gender, String type, double salary) {
        this.employe_id = employe_id;
        this.name = name;
